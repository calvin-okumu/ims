        ...
        <div className="inline-block align-bottom bg-white dark:bg-gray-800 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
          ...
          <div className="bg-white dark:bg-gray-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
            ...
            <form onSubmit={(e) => {
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onBlur={handleBlur}
                     className={`block w-full pl-10 pr-3 py-2 border rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-white ${
                       errors.pin && touched.pin ? 'border-red-300 dark:border-red-500' : 'border-gray-300 dark:border-gray-600'
                     }`}
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onBlur={handleBlur}
                     className={`block w-full pl-10 pr-3 py-2 border rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-white ${
                       errors.name && touched.name ? 'border-red-300 dark:border-red-500' : 'border-gray-300 dark:border-gray-600'
                     }`}
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onBlur={handleBlur}
                     className={`block w-full pl-10 pr-3 py-2 border rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-white ${
                       errors.email && touched.email ? 'border-red-300 dark:border-red-500' : 'border-gray-300 dark:border-gray-600'
                     }`}
              ...
              {/* Phone Field */}
              <div>
                <label htmlFor="mobilePhone" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                  Phone Number
                </label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  ...
                  <input
                    ...
                    onBlur={handleBlur}
                     className={`block w-full pl-10 pr-3 py-2 border rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-white ${
                       errors.mobilePhone && touched.mobilePhone ? 'border-red-300 dark:border-red-500' : 'border-gray-300 dark:border-gray-600'
                     }`}
          ...
          <div className="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
            ...
            <button
              ...
              className="mt-3 w-full inline-flex justify-center px-4 py-2 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 disabled:opacity-50 disabled:cursor-not-allowed sm:mt-0 sm:ml-3 sm:w-auto"
            >
              Cancel
            </button>
          </div>
