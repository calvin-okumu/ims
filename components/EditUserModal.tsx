...
const EditUserModal: React.FC<EditUserModalProps> = ({ isOpen, onClose, user, onUserUpdated }) => {
  ...
  return (
    <>
      <div className="fixed inset-0 bg-gray-900 bg-opacity-30 backdrop-blur-sm overflow-y-auto h-full w-full z-[60] flex items-center justify-center animate-in fade-in duration-200" onClick={handleClose}>
